  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Monitor admin login activity across the platform (member sessions are not tracked)</p>
      </div>

      <Alert>
        <AlertDescription>
          ℹ️ For privacy and performance reasons, login sessions are only tracked for admin and super admin users. Regular member logins are not recorded.
        </AlertDescription>
      </Alert>
