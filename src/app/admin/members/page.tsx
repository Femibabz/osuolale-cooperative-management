                    ...
                    <TableCell>
                      {member.loanBalance > 0 ? (
                        <div className="text-sm">
                          <div className={LoanCalculator.isLoanOverdue(member, settings) ? 'text-red-600 font-medium' : ''}>
                            {member.loanDurationMonths || settings.standardLoanTermMonths} months total
                          </div>
                          <div className="text-xs text-muted-foreground">
                            {LoanCalculator.getRemainingLoanMonths(member, settings)} months remaining
                          </div>
                          {LoanCalculator.isLoanOverdue(member, settings) && (
          ...
          {selectedMember && (
            <div className="space-y-6">
              ...
              <div className="border-t pt-4">
                ...
                {(() => {
                  const transactions = db.getTransactionsByMember(selectedMember.id, 12);
