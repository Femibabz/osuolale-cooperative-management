...
export default function LoansPage() {
  ...
  const handleApproveLoan = async () => {
    ...
    try {
      ...
      if (updatedLoan) {
        // Calculate monthly payment (principal + interest over 12 months)
        ...
        await db.updateMember(selectedMember.id, {
          ...
          loanInterestRate: 18, // 18% annual (1.5% monthly)
          monthlyLoanPayment: monthlyPayment,
          // Interest will be calculated monthly based on remaining balance
        });
