...
export default function TestFlowPage() {
  ...
  const testAdminLogin = async () => {
    ...
    const adminUser = db.findUserByEmail('admin@osuolale.com');
  ...
  const testSubmitApplication = async () => {
    ...
    try {
      ...
      const newApplication = db.createApplication(testApplicationData);
  ...
  const runAllTests = async () => {
    ...
    // Final state report
    const finalApplications = db.getApplications();
    const finalMembers = db.getMembers();
